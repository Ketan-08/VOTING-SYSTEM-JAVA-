...
class Voter extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        if(e.getSource()==b1)
        {
    		...
    		dispose();
    		int v_id = Integer.parseInt(t1.getText());
			...
			try {
				...
				String uname = "root";
				String pass = ""; 
				String query = ("Select * from voters where voter_id ='"+v_id+"' and password='"+pass_word+"'");
				...
				if(rs.next()) {
					...
					String participated = rs.getString(6);
					

					
					if(participated.equals("No"))
                                        {
						...
						JOptionPane.showMessageDialog(b1, "U have Alredy voted,so u cannot login again");
					...
					JOptionPane.showMessageDialog(b1, "Wrong Voterid & Password");
